...
We also look at the number of notes per melody.
'''

'''
I gave up on the jazz database, the below does the same 
...
# calculate number of events in melody
notes_per_melody = melody_df.groupby(['melid'], dropna=False)\
                            .count()['eventid']
...
solo_info_df['notes_per_melody'] = notes_per_melody.reset_index()['eventid']
# write to new table
